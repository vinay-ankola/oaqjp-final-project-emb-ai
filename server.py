...
def emot_detector():
    ...
    return f"For the given statement, the system response is {formatted_response} and" \
           f" {formatted_last_item}. The dominant emotion is {dominant_emotion}"
